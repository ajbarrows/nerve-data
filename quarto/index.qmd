...
```{python}
df, summary_table, n_subjects = scan_bids_directory("../ABCD/6.1/dairc/rawdata/")
...
```{python}
# df, summary_table, n_subjects = scan_bids_directory("../HBCD/2.0/rawdata/")
# print(f"Total Subjects: {n_subjects}")
# print(summary_table.to_markdown())
```
...
```{python}
df, summary_table, n_subjects = scan_bids_directory("../HBCD/1.1/rawdata/")
print(f"Total Subjects: {n_subjects}")
print(summary_table.to_markdown())
```
